...
function processKey(e) {
  ...
  if (!over && r == h) {
    over = true;
    document.getElementById("answerText").innerText = word;
...
function update() {
  ...
  for (let i = 0; i < w; i++) {
    curSelected = document.getElementById(r + "-" + i);
    //console.log(curSelected.innerText);
  ...
  for (let i = 0; i < w; i++) {
    ...
    curSelected = document.getElementById(r + "-" + i);
    let x = curSelected.innerText;
    // if (curSelected.classList.contains("correct")) continue;
    let letter = x[0];
  ...
  setTimeout(function () {
    for (let i = 0; i < w; i++) {
      ...
      if (state[i] == "c") {
        curSelected.classList.add("correct");
        //corrKey.classList.remove("active");
